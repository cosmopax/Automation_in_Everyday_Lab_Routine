    ...
    while True:
        ...
        try:
            ...
            if float(user_input) >= 0:
                ...
                print('Not a valid input. Enter a positive float and use . as comma.')
        except ValueError:
            print('Not a valid input. Enter a positive float and use . as comma.')
...
def calculate_reactorvalue(volume: float, length: float, diameter: float) -> float:
    ...
    if volume == 0:
        ...
        if diameter == 0 or length == 0:
            print('More than one value is 0, no valid calculation possible!')
            return None     
        ...
        # calculate length
        if diameter == 0 or volume == 0:
            print('More than one value is 0, no valid calculation possible!')
            return None
        volume_mm3 = volume * 1000
        return [(volume_mm3 / (3.14159265359 * r**2)), 'length', 'mm']
...
def get_reactordata(reactornumber: int) -> dict:
    ...
    while volume == 0 or length == 0 or diameter == 0:
...
def calculate_retentiontime(reactorvolume: float, syringes: list) -> float:
    ...
    if inflow == 0:
        print('Total inflow cannot be zero!')
        return None
        ...
        if task == '1':
            ...
            while True:
                ...
                if retention_time > 0:
                    ...
                    print('Retention time cannot be 0 or negative!')
